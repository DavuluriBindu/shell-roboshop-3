...
SG_ID="sg-0897c394fc2d256af" # replace with your SG ID
INSTANCES=("mongodb" "redis" "mysql" "rabbitmq" "catalogue" "user" "cart" "shipping" "payment" "dispatch" "frontend")
ZONE_ID="Z04547231YPUT2HMMPAFC" # replace with your ZONE ID
DOMAIN_NAME="devops84.site" # replace with your domain
